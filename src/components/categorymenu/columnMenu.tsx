export const Column_menu = () => {
  return (
    <div className='md:grid md:grid-cols-2 md:gap-2 '>
      <div className=' text-white bg-center bg-cover rounded  bg-[url("/src/assets/lamp.jpg")] m-2 md:m-0'>
      ...
      <div className=' text-white bg-center bg-cover rounded  bg-[url("/src/assets/banner_img2.jpg")] m-2 md:m-0'>
        <div className='flex flex-col justify-evenly p-5 space-y-2 bg-black bg-opacity-25 h-[100%] '>
      ...
      <div className=' bg-center bg-cover rounded  bg-[url("/src/assets/banner_img3.jpg")] m-2 md:m-0'>
        <div className='flex flex-col justify-evenly p-5 space-y-2 items-center w-[50%]  h-[100%] text-center '>
          <div className=' text-[gray] font-bold text-sm'>Amazing Value</div>
          <div className=' font-bold '>Premium Quality</div>
          <div className=' font-bold '>Combo Collection 2024</div>
      ...
      <div className=' text-white bg-center bg-cover rounded  bg-[url("/src/assets/banner_img4.jpg")] m-2 md:m-0'>
        <div className='flex flex-col justify-evenly p-5 space-y-2 bg-black items-end  bg-opacity-25 h-[100%] '>
          ...
          <div className=' bold text-2xl w-[60%] text-center'>
            BMW Series Available
          </div>
          <div className=' w-[50%] text-center  '>Popular Car Available</div>
